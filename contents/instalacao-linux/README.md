Para instalar o Ruby de maneira rápida e simples, abra um emulador de terminal, digite "terminal" na ferramenta de pesquisa de sua interface gráfica ou *CTRL + ALT + T* para abrir via atalho.
